...
<div class="coluna" style="width:100%">
	<div class="box">
		<div class="titulo azul2">ADICIONAR DOCUMENTO</div>
		<div class="corpo">
			<div class="item azul2">
				<span class="item">TIPO DE DOCUMENTO</span>
				<input class="oq" type="radio" name="oq[]" value='1' data-labelauty="Portaria"/>
				<input class="oq" type="radio" name="oq[]" value='1' data-labelauty="Documento interno"/>
			...
			<div class="botao azul2" onclick="setCKEditorToTextarea();docs.adiciona();">ADICIONAR DOCUMENTO</div>
		</div>
	</div>
</div>
<script>
